      ...
      datasets: [
        {
          ...
          backgroundColor: latest_publishers.map(publisher => generateRandomColor()),
        },
      ],
    };
      ...
      >
        <Flex direction="column" py="5px" ml="30px">
          ...
          <Text fontSize="lg" color={textColor} fontWeight="700">
            {latest_publishers[0].publisher.substring(0, 10) + "..." + latest_publishers[0].publisher.slice(-10)}
          </Text>
        </Flex>
      </Card>
    </Card>
